...
class SerialBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
                 drop_path=0., act_layer=GELU(), norm_layer=nn.LayerNorm, shared_cpe=None, shared_crpe=None):
        super().__init__()
...
class ParallelBlock(nn.Module):
    ...
    def __init__(self, dims, num_heads, mlp_ratios=[], qkv_bias=False, drop=0., attn_drop=0.,
                 drop_path=0., act_layer=GELU(), norm_layer=nn.LayerNorm, shared_crpes=None):
        super().__init__()
